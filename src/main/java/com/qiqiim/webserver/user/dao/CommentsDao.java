...
public class CommentsDao {
	...
	public static ArrayList<CommentDetail> selectCommentsByCount(boolean isChecking, boolean isMeeting,int id,int count){
		...
		if(isMeeting){
			...
			sql1 = "select id from " + table + " where meetingid = " + id + " limit 1";
			...
			sql1 = "select userId from " + table + " where id = " + id + " limit 1";
